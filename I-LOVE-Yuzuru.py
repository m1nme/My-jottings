...
def mail(data,block):
    ...
    # 收信方邮箱
    to_addr = 'xxxxxxxxxxxxxx@qq.com'
    # 发信服务器
    smtp_server = 'smtp.qq.com'
    # 邮箱正文内容，第一个参数为内容，第二个参数为格式(plain 为纯文本)，第三个参数为编码
    msg = MIMEText('send by xxxxxxxx', 'plain', 'utf-8')
    # 邮件头信息
...
if __name__ == '__main__':
    type = {"0206":"19016425","0207": "19016426","0208": "19016427","0209": "19016428", "gala": "19016424", "package": "19016423"}
    for key in type:
